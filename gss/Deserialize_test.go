...
func TestDeserialize(t *testing.T) {
	...
	for _, testCase := range deserializeTestCases {
		...
		got, err := DeserializeString(testCase.String, testCase.Format, testCase.Header, testCase.Comment, testCase.LazyQuotes, testCase.SkipLines, testCase.Limit, testCase.Type, false)
		if err != nil {
