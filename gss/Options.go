...
func (o Options) DeserializeBytes(content []byte, verbose bool) (interface{}, error) {
	return DeserializeBytes(content, o.Format, o.Header, o.Comment, o.LazyQuotes, o.Limit, o.Type, verbose)
}
...
func (o Options) DeserializeString(content string, verbose bool) (interface{}, error) {
	return DeserializeString(content, o.Format, o.Header, o.Comment, o.LazyQuotes, o.Limit, o.Type, verbose)
}
